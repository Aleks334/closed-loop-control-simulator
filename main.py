...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            ...
            html.Div([
                html.H3("Nastawy Regulatora PI (Przyrostowy)", style={'color': colors['text']}),
...
def update_simulation(n_clicks, p_sp_bar, V, kv, tsim, Kp, Ti, p_min_bar, u_min, u_max):
    ...
    fig_pressure.update_layout(
        title="Odpowiedź kompresora: ciśnienie w zbiorniku",
    ...
    fig_control.update_layout(
        title="Odpowiedź regulatora: Sygnał sterujący kompresora",
        xaxis=dict(title="Czas [s]", dtick=60),
